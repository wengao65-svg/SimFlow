"""Tool: Build a compact read-only SimFlow handoff summary."""

from runtime.simflow_core.state import ProjectRootError
from runtime.simflow_core.status import build_handoff_summary
...
def execute(params: dict) -> dict:
    try:
        ...
        summary = build_handoff_summary(project_root)
