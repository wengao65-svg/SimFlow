...
EXEMPT_TOOLS = frozenset({
    ...
    "simflow_state/project_reentry",
    "simflow_state/experiment_timeline",
    "simflow_state/session_handoff",
    "hpc/dry_run",
    "hpc/status",
})
...
PROTECTED_TOOLS = {
    ...
    "simflow_state/begin_experiment": ["simflow_state/read_state"],
    "simflow_state/finish_experiment": ["simflow_state/read_state"],
    "simflow_state/begin_iteration": ["simflow_state/read_state"],
    "simflow_state/evaluate_iteration": ["simflow_state/read_state"],
    "simflow_state/start_activity": ["simflow_state/read_state"],
    "simflow_state/finish_activity": ["simflow_state/read_state"],
